...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        save : function() {
            ...
            var markedOptions = this.markedOptions = {
                ...
                breaks      : true,
                pedantic    : false,
                sanitize    : (settings.htmlDecode) ? false : true,  // ????HTML??,?????HTML??,???false
                smartLists  : true,
                smartypants : true
            };
     ...
     * @returns {Renderer} markedRenderer  ??marked?Renderer?????
     */
     ...
     * 
     * @param   {Array}    toc             ?marked???TOC????
     * @param   {Element}  container       ??TOC?????
     * @param   {Integer}  startLevel      Hx ????
     * @returns {Object}   tocContainer    ??ToC??????jQuery????
     */
     ...
     * 
     * @param   {Object}   container       ??TOC???jQuery????
    ...
    editormd.markdownToHTML = function(id, options) {
        ...
        var markedOptions = {
            ...
            breaks      : true,
            pedantic    : false,
            sanitize    : (settings.htmlDecode) ? false : true, // ????HTML??,?????HTML????,?????,?????
            smartLists  : true,
            smartypants : true
        };
